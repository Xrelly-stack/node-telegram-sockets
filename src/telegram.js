...
class TelegramSockets extends EventEmitter {
  /**
   * Socket-like alias for 'on'
   */
  ...
  startPolling(options = {}) {
    ...
    if (!this._polling) {
      this._polling = new TelegramSocketsPolling(this);
    }
  ...
  openWebHook() {
    ...
    if (!this._webHook) {
      this._webHook = new TelegramSocketsWebHook(this);
    }
